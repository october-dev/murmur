...
This design distills the voice runtime patterns already exercised in Wega
Labs' October Desktop app into public, implementation-independent contracts.
The goal is to let contributors improve the hard, reusable parts of voice once
and share those improvements across Murmur, October, and other applications.
No October product commands, account rules, private endpoints, or third-party
native implementation code are part of this extraction.
...
## What is intentionally not moved from October
...
- October UI components, IPC names, and application state
